...
const MENU_ITEMS = [
  ...
  { id: "i3", name: "Paneer Butter Masala", description: "Cottage cheese cubes in silky tomato-butter gravy", price: 4e3, category: "Indian", diet: ["VEG"], image: img("photo-1631452180519-c014fe946bc7") },
  { id: "i4", name: "Chicken Tandoori (Half)", description: "Marinated chicken slow-roasted in clay oven", price: 5e3, category: "Indian", diet: ["NON-VEG"], image: img("photo-1599487488170-d11ec9c172f0") },
  ...
  { id: "i7", name: "Plain Rice", description: "Steamed basmati", price: 1e3, category: "Indian", diet: ["VEG"], image: img("photo-1516684732162-798a0062be99") },
  { id: "i8", name: "Lamb Biryani", description: "Slow-cooked lamb with aromatic rice and saffron", price: 6e3, category: "Indian", diet: ["NON-VEG", "SPICY"], image: img("photo-1633945274405-b6c8069047b0") },
  ...
  // African
  { id: "a1", name: "Akumé", description: "Traditional Togolese corn porridge served with sauce", price: 2e3, category: "African", diet: ["VEG"], image: img("photo-1574484284002-952d92456975") },
